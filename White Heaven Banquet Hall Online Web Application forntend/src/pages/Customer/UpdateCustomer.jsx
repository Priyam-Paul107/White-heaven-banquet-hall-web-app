...
import { registerCustomer, updateCustomerById } from "../../../services/axiosClientService";
...
export default function updateCustomer() {
  ...
  const submitHandler = async(e) => {
    ...
    try {
     ...
     const res= await updateCustomerById(formData,id);
  ...
  return (
    ...
    <div className="flex justify-center">
      ...
      >
        ...
        <button className="w-full mb-3 bg-primary cursor-pointer hover:bg-secondary 600 transition-all active:scale-95 py-2.5 rounded text-white font-medium">
          Edit Account
        </button>
